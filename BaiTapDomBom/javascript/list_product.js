listItem0 = document.getElementById('js-list-item');
listItem1 = document.getElementById('js-list-item-2');
...
function renderList(start, end, tag) {
  ...
  for (i; i < end; i++) {
    ...
    btnAdd.className = 'js-btn-add-tocart';
...
listButton = document.getElementsByClassName('js-btn-add-tocart');
