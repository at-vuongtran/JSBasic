var arrQuantity = document.getElementsByClassName('js-quantity-product');
var data = JSON.parse(localStorage.getItem('products'));
var table = document.getElementById('js-list-cart-view');
var index = 0;
for (index; index < data.length; index++) {
    ...
    input.className = 'js-quantity-product';
    input.type = 'number';
    ...
    tdSubTotal.className = 'js-tb-col js-sub-total';
    ...
    buttonRM.className = 'js-btn-remove';
    buttonRM.append('X');
...
var arrSubTotal = document.getElementsByClassName('js-sub-total');
var listInput = document.getElementsByClassName('js-quantity-product');
var totalPrice = document.getElementById('js-total');
var listButtonRM = document.getElementsByClassName('js-btn-remove');
...
for (i = 0; i < listButtonRM.length; i++) {
    listButtonRM[i].addEventListener('click', function() {
        ...
        var subTotal = tr.querySelector('.js-sub-total');
